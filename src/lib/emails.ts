    ...
    <div style="background:#16121f;border:1px solid #2d2050;border-radius:16px;padding:32px;">
      ...
      <div style="background:#1e1828;border-radius:12px;padding:20px;margin-bottom:24px;">
        <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
          <span style="color:#8b7daa;">Item</span>
        ...
        <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
          <span style="color:#8b7daa;">Amount</span>
          <span style="font-weight:600;color:#10b981;">${currency} ${amount.toFixed(2)}</span>
        </div>
        <div style="display:flex;justify-content:space-between;">
          <span style="color:#8b7daa;">Reference</span>
          <span style="font-weight:600;font-family:monospace;font-size:12px;">${licenseId.substring(0, 16).toUpperCase()}</span>
        </div>
      </div>
      
      <a href="${downloadUrl}" style="display:block;background:linear-gradient(135deg,#7c3aed,#5b21b6);color:white;text-decoration:none;text-align:center;padding:16px 32px;border-radius:12px;font-weight:700;font-size:16px;margin-bottom:16px;">
        ⬇️ Download Now
      </a>
    ...
    <div style="background:#16121f;border:1px solid #2d2050;border-radius:16px;padding:32px;margin-top:24px;">
      ...
      <div style="background:#1e1828;border-radius:12px;padding:20px;margin-bottom:24px;">
        ...
        <div style="border-top:1px solid #2d2050;padding-top:12px;margin-top:12px;">
          ...
          <div style="display:flex;justify-content:space-between;">
            <span style="color:#f0eafa;font-weight:700;">You receive</span>
            <span style="color:#10b981;font-weight:700;font-size:20px;">${currency} ${netAmount.toFixed(2)}</span>
          </div>
        </div>
      </div>
...
// Support notification to artist
