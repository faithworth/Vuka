      ...
      <div className="flex items-center justify-center min-h-[80vh] px-4">
        <div className="w-full max-w-md p-8 rounded-2xl" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          <div className="text-center mb-8">
            ...
            <p style={{ color: 'var(--muted)' }}>Enter the email you used to buy and we'll send fresh download links.</p>
          </div>
          {sent ? (
            <div className="text-center p-6 rounded-xl" style={{ background: 'var(--surface2)', border: '1px solid var(--border)' }}>
              ...
              <p style={{ color: 'var(--muted)' }}>We've sent fresh download links to <strong style={{ color: 'var(--purple-light)' }}>{email}</strong></p>
            </div>
          ) : (
