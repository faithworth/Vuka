    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-muted)] mt-1">Log in to your hustle</p>
        </div>

        <div className="card p-8">
          <button onClick={handleGoogle} className="btn btn-secondary w-full mb-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="btn btn-primary w-full py-4">
              {loading ? 'Just now…' : 'Log In'}
            </button>
          </form>

          <p className="text-center text-sm text-[var(--text-muted)] mt-6">
            No account?{' '}
            <Link href="/auth/register" className="text-[var(--purple-light)] hover:underline">
              Rise Up — it&apos;s free
            </Link>
          </p>
        </div>
