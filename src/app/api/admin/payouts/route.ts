        ...
        try {
          ...
          if (artistEmail) {
            await sendPayoutApproved({
              ...
              payoutMethod: request.bankAccount ? 'Bank Transfer' : 'PayFast',
      ...
      case 'mark_paid': {
        ...
        await prisma.artistPayout.create({
          data: {
            ...
            status:      'paid',
            method:      request.bankAccount ? 'bank' : 'payfast',
            reference:   reference || '',
        ...
        try {
          ...
          if (artistEmail) {
            await sendPayoutProcessed({
              ...
              bankLast4: (request.bankAccount as any)?.maskedNumber?.slice(-4),
              payoutsUrl: `${APP_URL()}/dashboard/payouts`,
            });
          }
