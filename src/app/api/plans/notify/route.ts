...
// PLAN_ references to handlePlanEvent automatically. This route is kept as
// a standalone wrapper around the same handler for backward compatibility
// and direct testing.

export const dynamic = 'force-dynamic';
import { NextRequest, NextResponse } from 'next/server';
import { verifyPaystackWebhook } from '@/lib/paystack';
import { handlePlanEvent } from '@/lib/webhooks/paystack-handlers';
