    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <Section title="5. Your Rights (POPIA & GDPR)">
          <p>You have the right to: access the personal data we hold about you; correct inaccurate data; request deletion (subject to legal retention requirements); object to processing; and data portability. Submit requests to support@vukamusic.com.</p>
        </Section>
        ...
        <Section title="8. Contact">
          <p>For any privacy concerns, contact us at <a href="mailto:support@vukamusic.com" className="underline" style={{ color: 'var(--sky)' }}>support@vukamusic.com</a>.</p>
        </Section>
