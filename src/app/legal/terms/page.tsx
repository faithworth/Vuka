    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <Section title="5. Payments, Artist Royalties & Payouts">
          <p>All prices are displayed in South African Rand (ZAR). Buyers pay Vuka Music directly through the payment provider presented at checkout, which may include Paystack or Yoco for supported South African transactions. International buyers and artists may use PayPal where enabled for the relevant transaction and account.</p>
          ...
          <p>Vuka Music does not store payment card information. Card and payment details are handled by the applicable payment provider presented at checkout, including Paystack or Yoco where enabled, under that provider's security and compliance controls.</p>
        </Section>
