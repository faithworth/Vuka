    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <Section title="1. About Vuka">
          <p>Vuka ("we", "us", "the platform") is a digital music marketplace operated by Faithworth, Republic of South Africa. These Terms govern your use of vuka-distro.vercel.app and all related services.</p>
        ...
        <Section title="6. No Refund Policy">
          ...
          <p>If you believe you were charged incorrectly or did not receive access to your purchase, contact us at support@vuka-distro.vercel.app within 7 days and we will investigate.</p>
        </Section>
        ...
        <div className="mt-10 pt-8" style={{ borderTop: '1px solid var(--border)' }}>
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
            Questions? Email <a href="mailto:support@vuka-distro.vercel.app" className="underline" style={{ color: 'var(--sky)' }}>support@vuka-distro.vercel.app</a>
