      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ...
          <div>
            ...
            <p className="mt-2">To raise an exception, email <a href="mailto:support@vuka-distro.vercel.app" className="underline" style={{ color: 'var(--sky)' }}>support@vuka-distro.vercel.app</a> within 7 days with your order reference.</p>
          </div>
